...
title: Markdown Tree
description: A simple program to generate a dynamic site based on a folder hierarchy of Markdown files. Perfect for small textual sites use.<br/><a href="http://notes.bladdo.net">Example Site</a>&nbsp;&nbsp;//&nbsp;&nbsp;<a href="http://github.com/mil/markdown-tree/tree/master/content">Example Site Folder Structure</a>
---
